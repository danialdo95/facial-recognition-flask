...
def upload_image():
    ...
    <h1>Upload a picture of a face and see if it's a picture recognize by the system</h1>
...
def detect_faces_in_image(file_stream):
    ...
    image_of_barrack = face_recognition.load_image_file('./known/Danial.jpg')
    ...
    if len(unknown_face_encodings) > 0:
        ...
        for filename in os.listdir('./known'):
            if filename.endswith(".jpg") or filename.endswith(".png"): 
                ...
                image_of_barrack = face_recognition.load_image_file('./known/' + filename)
                print(filename)
